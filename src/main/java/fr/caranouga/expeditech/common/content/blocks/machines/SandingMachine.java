package fr.caranouga.expeditech.common.content.blocks.machines;
...
public class SandingMachine extends AbstractMachineBlock {
    public static final BooleanProperty POWERED = BlockStateProperties.POWERED;

    public SandingMachine() {
        super("sanding_machine");
    ...
    protected TileEntityType<? extends TileEntity> getTileEntityType(BlockState state, IBlockReader world) {
        return ModTileEntities.SANDING_MACHINE_TILE.get();
    }
    ...
    protected Container getContainer(int i, World pLevel, BlockPos pPos, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        return new SandingMachineContainer(i, pLevel, pPos, playerInventory, playerEntity);
    }
    ...
    public void onRemove(BlockState pState, World pLevel, BlockPos pPos, BlockState pNewState, boolean pIsMoving) {
        if(pState.getBlock() != pNewState.getBlock()){
            ...
            if(tile instanceof SandingMachineTile){
                ((SandingMachineTile) tile).drops();
            }
        }
